...
public class TypeCheckArray {
    ...
    * */
    private static HashMap<Integer, HashMap<String, Double>> pokemonTypes = new HashMap<>();
    ...
    static {
        ...
        pokemonTypes.get(12).put("Grass", 1.0);
        pokemonTypes.get(12).put("Water", 1.0);
        pokemonTypes.get(12).put("Fire", 1.0);
        pokemonTypes.get(12).put("Electric", 1.0);
        pokemonTypes.get(12).put("Fighting", 1.0);
        pokemonTypes.get(12).put("Flying", 1.0);
        pokemonTypes.get(12).put("Ground", 1.0);
        pokemonTypes.get(12).put("Rock", 1.0);
